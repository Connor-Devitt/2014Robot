...
public class CameraVision {
    ...
    //Camer constants used for distance calculation
    private final int Y_IMAGE_RES = 480;        //X Image resolution in pixels, should be 120, 240, or 480
    private final double VIEW_ANGLE = 49;       //Axis M1013 Camera
    ...
    /**
         ...
         * algorithm described above. This sample will either
         * get images from the camera or from an image file
         * stored in the top level directory in the flash memory
    ...
    private void captureImage() {
        ...
        try {
            ...
            //iterate though each particle and score to see if it is a target
            ...
            if (filteredImage.getNumberParticles() > 0) {
                ...
                for (int i = 0; i < verticalTargetCount; i++) {
                    ...
                    for (int j = 0; j < horizontalTargetCount; j++) {
                        ...
                        if (total > target.totalScore) {
                            target.horizontaIndex = horizontalTargets[j];
                ...
                if (verticalTargetCount > 0) {
                    ...
                    target.distance = computeDistance(filteredImage, distanceReport, target.verticalIndex);
                    /*
                    if (target.Hot) {
